        ...
        <div className='text-white'>
            <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center '>
                ...
                <div className="flex justify-center items-center ">
                    ...
                    <Typed className="md:text-5xl sm:text-4xl text-xl font-bold md:pl-4 pl-4 text-gray-500"
                        strings = {[ 'BTB' , 'SAP' , 'BTC' ]} 
                        typeSpeed={120} 
                        backSpeed={140} 
                        loop 
                ...
                <p className="md:text-2xl text-xl font-bold text-gray-500" >Monitor your data analytics to increase revenue fro BTB , SAP  & BTC Plactforms.</p>
